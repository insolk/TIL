...
kubeadm init --pod-network-cidr=10.96.0.0/16 --apiserver-advertise-address=192.168.56.10
  ...
  ```  
kubeadm join 192.168.56.10:6443 --token 995vqn.j0c918mjvxb2guwv \
    --discovery-token-ca-cert-hash sha256:aa6b1cd7553bb09a2e99e0878592e4bfe48b9cb862baf6397cb0d992c164aa9f 
  ```
  - 환경 변수 설정
  ```
mkdir -p $HOME/.kube
